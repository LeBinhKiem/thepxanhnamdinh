    ...
    <form method="get" class="form-inline">
        <div class="row">
            <div class="col-lg-3 col-sm-6 col-md-12 p-2">
                <input type="text" value="{{ form_query("id",$query) }}" name="id" placeholder="Nhập ID danh mục"
            ...
            <div class="col-lg-3 col-sm-12 col-md-12 p-2">
                ...
                <a href="{{ route("get.categories.index") }}" class="btn btn-light ">Xóa lọc</a>
            </div>
        </div>

    </form>
    <a href="{{ route("get.categories.create") }}" class="btn btn-primary float-end mb-3">
    ...
    <div class="container-table">
        <table class="table" style="table-layout: fixed; width: 100%;">
            ...
            <tr>
                ...
                <th scope="col" width="30%">Trạng thái</th>
                <th scope="col" width="30%">Ngày cập nhật</th>
            </tr>
            </thead>
            <tbody>
            @if(count($items) > 0)
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item"
                                           href="{{ route("get.categories.edit", $item->id) }}">
