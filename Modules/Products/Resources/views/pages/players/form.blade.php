<form method="post" action="{{ $action }}" enctype="multipart/form-data">
    ...
    <div class="form-group {{ has_error($errors,"name") }}">
        <div class="row">
            <div class="col-2">
                <b class="form-text mb-2">Tên cầu thủ <span class="text-danger">*</span></b>
            </div>
            <div class="col-10">
    ...
    <div class="form-group {{ has_error($errors,"shirt_number") }}">
        <div class="row">
            <div class="col-2">
                <b class="form-text mb-2">Số áo <span class="text-danger">*</span></b>
            </div>
            <div class="col-10">
                <input class="form-control form-control-sm" name="shirt_number" type="text" placeholder="Số áo"
                       value="{{ old_input("shirt_number",$item ?? []) }}">
                {!! get_error($errors,"shirt_number") !!}
            </div>
        </div>
    </div>
    ...
    <div class="form-group {{ has_error($errors,"height") }}">
        <div class="row">
            <div class="col-2">
                <b class="form-text mb-2">Chiều cao <span class="text-danger">*</span></b>
            </div>
            <div class="col-10">
                <input class="form-control form-control-sm" name="height" type="number" placeholder="Chiều cao"
                       value="{{ old_input("height",$item ?? 0) }}">
                {!! get_error($errors,"height") !!}
            </div>
        </div>
    </div>
    <div class="form-group {{ has_error($errors,"weight") }}">
        <div class="row">
            <div class="col-2">
                <b class="form-text mb-2">Cân nặng <span class="text-danger">*</span></b>
            </div>
            <div class="col-10">
                <input class="form-control form-control-sm" name="weight" type="number" placeholder="Cân nặng"
        ...
        <div class="row">
            ...
            <div class="col-10">
                <select class="form-control form-control-sm" name="position">
                    ...
                    @foreach(\Modules\Products\Enums\PlayerEnum::POSITION as $index => $value)
                        <option
    ...
    <div class="form-group {{ has_error($errors,"team") }}">
        <div class="row">
            <div class="col-2">
                <b class="form-text mb-2">Team <span class="text-danger">*</span></b>
            </div>
            <div class="col-10">
                <select class="form-control form-control-sm" name="team">
                    <option value="">--Chọn team--</option>
                    @foreach(\Modules\Products\Enums\PlayerEnum::TEAM as $index => $value)
                        <option
                                {{ old_input("team", $item ?? []) == $value ? "selected" : "" }}
                                value="{{ $value }}">{{ $value }}
                        </option>
                    @endforeach
                </select>
                {!! get_error($errors,"team") !!}
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <a href="{{ route("get.players.index") }}" class="btn btn-light "><i
